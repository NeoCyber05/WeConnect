...
export default function Index() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      {/* Left dark panel */}
      <div className="relative hidden md:flex flex-shrink-0 md:w-5/12 lg:w-[42%] md:min-h-screen overflow-hidden bg-[#050B14]">
        {/* Gradient background */}
        <div
      ...
      <div className="flex-1 bg-white flex flex-col min-h-screen">
        ...
        <div className="flex md:hidden items-center justify-center gap-3 pt-6 pb-2">
          {/* Logo SVG (same as left panel's logo) */}
          <svg
            width="34"
            height="29"
            viewBox="0 0 34 29"
          ...
          <span className="text-[#050B14] font-bold text-xl">WeConnect</span>
        </div>
